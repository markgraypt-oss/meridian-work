...
function DashboardGoalCard({ goal, navigate, formatDate }: { goal: Goal; navigate: (path: string) => void; formatDate: (date: Date | string, variant?: "full" | "short" | "withDay" | "monthDay") => string }) {
