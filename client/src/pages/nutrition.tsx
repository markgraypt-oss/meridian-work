                    ...
                    <div className="space-y-3">
                      ...
                      {aiInsightsData.data.suggestions?.map((s: any) => (
                        <Link
                          key={s.id}
                          href={`/recipe/${s.id}`}
                          className="block bg-background rounded-lg overflow-hidden border-l-4 border-l-orange-500/50 hover:border-l-orange-500 hover:bg-background/80 transition-all"
                          data-testid={`link-recipe-${s.id}`}
                        >
                          {s.imageUrl && (
                            <div className="w-full h-32 bg-muted overflow-hidden">
                              <img src={s.imageUrl} alt={s.title} className="w-full h-full object-cover" loading="lazy" />
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex gap-2">
                ...
                <Button
                  variant="ghost"
                  size="sm"
                  onClick={() => navigate('/nutrition/macro-targets')}
                  data-testid="button-edit-macro-targets"
                  title="Edit macro tracker targets"
                >
