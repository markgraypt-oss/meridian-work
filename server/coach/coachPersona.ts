...
- CANONICAL DAY SKELETON. A full-body or lower day runs: A. lower main lift (STRAIGHT set) → B. lower accessory (straight set) → C1/C2 push+pull antagonist superset → D. shoulder-health / core / conditioning. An upper day runs: A1/A2 main push+pull superset → B1/B2 secondary push+pull superset → C. shoulder-health ancillary.
